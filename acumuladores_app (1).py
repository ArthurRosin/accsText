...
COMMODITIES = {
    ...
    "Milho B3": {
        "unidade": "R$/sc",
        "pilares": {
            "CCMH6": date(2026, 2, 27),
            "CCMK6": date(2026, 4, 30),
            "CCMN6": date(2026, 6, 30),
            "CCMQ6": date(2026, 7, 31),
            "CCMU6": date(2026, 8, 31),
            "CCMV6": date(2026, 9, 30),
            "CCMX6": date(2026, 10, 30),
            "CCMZ6": date(2026, 11, 30),
            "CCMF7": date(2027, 1, 30),
        },
    },
    "Algodão": {
        "unidade": "c/lb",
...
TIPOS_ACC = {
    ...
    # "ACC sem dobro, com Acelerador e KO" — removido por inviabilidade
...
def gerar_texto(
    ...
    # ── Cabeçalho (primeira linha em negrito via markdown) ──────────────────
